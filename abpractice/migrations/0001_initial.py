# Generated by Django 4.1.2 on 2022-12-10 10:31

import abpractice.validator
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(null=True, upload_to='cars', validators=[abpractice.validator.validate_image])),
                ('specs', models.FileField(null=True, upload_to='specs', validators=[abpractice.validator.validate_file])),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='abpractice.category')),
            ],
        ),
        migrations.CreateModel(
            name='Placed_Order',
